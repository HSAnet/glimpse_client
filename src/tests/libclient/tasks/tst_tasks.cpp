...
private slots:
    ...
    void uniqueTasks()
    {
        ...
        Task task1 = scheduler.nextImmediateTask("ping", pingDef1.toVariant());
        ...
        Task task2 = scheduler.nextImmediateTask("ping", pingDef2.toVariant());
        ...
        Task task3 = scheduler.nextImmediateTask("ping", pingDef1.toVariant());
