...
#define NETSNMP_CONFIGURE_OPTIONS " '--disable-applicatins' '--disable-agent' '--disable-manuals' '--disable-scripts' '--without-rpm' '--disable-embedded-perl' '--disable-cc-perl-checks' '--prefix=/home/christian/net-snmp-lib'"
