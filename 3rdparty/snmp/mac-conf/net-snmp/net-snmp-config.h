...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/Users/Christian/net-snmp-lib' '--disable-agent' '--disable-manuals' '--disable-scripts' '--disable-applications' '--disable-embedded-perl' '--disable-perl-cc-checks' '--without-rpm'"
